...
```sh
  git clone git@github.com:MudasirSherwani/Hello-Rails-React.git
...
Feel free to check the [issues page](https://github.com/MudasirSherwani/Hello-Rails-React/issues).
...
This project is [MIT](https://github.com/MudasirSherwani/Hello-Rails-React/blob/main/LICENSE) licensed.
